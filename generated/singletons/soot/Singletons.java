...
public class Singletons {
    ...
    private soot.jimple.toolkits.annotation.moduli.ModuliTagger instance_soot_jimple_toolkits_annotation_moduliTagger;
    public soot.jimple.toolkits.annotation.moduli.ModuliTagger instance_soot_jimple_toolkits_annotation_moduliTagger() {
        if( instance_soot_jimple_toolkits_annotation_moduliTagger == null ) {
	       	synchronized (this) {
		        if( instance_soot_jimple_toolkits_annotation_moduliTagger == null )
	        		instance_soot_jimple_toolkits_annotation_moduliTagger = new soot.jimple.toolkits.annotation.moduli.ModuliTagger( g );
	       	}
       	}
        return instance_soot_jimple_toolkits_annotation_moduliTagger;
    }
    
    private soot.jimple.toolkits.annotation.moduli.PreciseModuliTagger instance_soot_jimple_toolkits_annotation_preciseModuliTagger;
    public soot.jimple.toolkits.annotation.moduli.PreciseModuliTagger instance_soot_jimple_toolkits_annotation_PreciseModuliTagger() {
        if( instance_soot_jimple_toolkits_annotation_preciseModuliTagger == null ) {
	       	synchronized (this) {
		        if( instance_soot_jimple_toolkits_annotation_preciseModuliTagger == null )
		        	instance_soot_jimple_toolkits_annotation_preciseModuliTagger = new soot.jimple.toolkits.annotation.moduli.PreciseModuliTagger( g , 10);
	       	}
       	}
        return instance_soot_jimple_toolkits_annotation_preciseModuliTagger;
    }
